...
Each node of the list contains the position of each block of the snake with x and y coordinates, and movement is created by inserting a node at the head and deleting a node at the tail simultaneously.
